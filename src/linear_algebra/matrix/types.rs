...
macro_rules! to_mat {
    (
        ...
        paste::paste! {
            $(
                pub fn [<to_mat $mat_convert>](self) -> crate::linear_algebra::matrix::types::[<Mat $mat_convert>]<N> {
                    let mut out = crate::linear_algebra::matrix::types::[<Mat $mat_convert>]::identity();
